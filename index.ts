...
import { ChatBuffer, DiscordExternalDependencies } from "./src/helpers/types.js"
...
const other_dependencies: DiscordExternalDependencies = {commands, aliases, chat_buffer, settings};
//////////////////////////////////////////////////////////////////////////////////
if (!settings.test) await enableAutoDelete()

client.on("messageUpdate", async (msg) => await messageUpdate(client, msg, chat_buffer));
client.on("messageDelete", async (msg) => await messageDelete(client, msg, chat_buffer));
client.on("messageCreate", async (msg) => await messageCreate(client, msg, other_dependencies))
