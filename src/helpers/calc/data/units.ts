...
const weight: JSONEdges = [
	...
	{ from: "g", to: "mcg", forward_weight: 1e6, backward_weight: 1 / 1e6 },
	{ from: "g", to: "ng", forward_weight: 1e9, backward_weight: 1 / 1e9 },

	{
		from: "lb",
		to: "g",
		forward_weight: 453.5924,
		backward_weight: 1 / 453.5924,
	},
	...
	{ from: "gr", to: "lb", forward_weight: 7000, backward_weight: 1 / 7000 },
	{
		from: "lb",
		to: "carat",
		forward_weight: 2267.962,
		backward_weight: 1 / 2267.962,
	},
	...
	{ from: "lton", to: "lb", forward_weight: 2240, backward_weight: 1 / 2240 },
	{
		from: "mton",
		to: "lb",
		forward_weight: 2204.623,
		backward_weight: 1 / 2204.623,
	},
];
...
const length: JSONEdges = [
...

	{
		from: "m",
		to: "in",
		forward_weight: 39.370078740157,
		backward_weight: 1 / 39.370078740157,
	},
