...
const commands = new Collection()
    .concat((await importDirectories("", "./src/commands/")), (await importDirectories(__dirname, "/src/commands/specials/")), (await importDirectories(__dirname, "/src/commands/settings/")));
const cooldowns = new Collection();
console.log(`Imported ${chalk.bgGreen(`${commands.size} commands`)}.`);
const websites = await grabAllRandomWebsites(path.join("./media/randomweb.jsonl"));
